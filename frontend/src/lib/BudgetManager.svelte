...
<div>
  ...
  <div>
    ...
    <div class="card-sub p-5">
      ...
      {#if addError}
        <div class="bg-red-950/40 border border-red-800 text-red-400 rounded-xl px-3.5 py-2 text-xs mb-3">{addError}</div>
      {/if}
      <div class="flex flex-wrap gap-3 items-end">
        <div class="flex flex-col gap-1 flex-1 min-w-[130px]">
          <label for="bcat" class="text-xs font-medium text-neutral-400">Category</label>
          <select
        ...
        <div class="flex flex-col gap-1 min-w-[130px] max-w-[160px]">
          <label for="bmonth" class="text-xs font-medium text-neutral-400">Month</label>
          <input
        ...
        <div class="flex flex-col gap-1 min-w-[110px] max-w-[140px]">
          <label for="blimit" class="text-xs font-medium text-neutral-400">Limit ({$currencySymbol})</label>
          <input
